            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.product.update',$product) }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <img src="{{asset('images/products/'.$product->image)}}" alt="" width="320px">
                        ...
                        <div class="row pb-2">
                            <div class="col-6 pt-2">
                                ...
                                <input type="text" class="form-control" name="product_name" id="product_name"
                                    value="{{ old('product_name', $product->name) }}" placeholder="ชื่อสินค้า">
                            </div>
                            <div class="col-6 pt-2">
                                ...
                                <input type="number" class="form-control" name="product_price" id="product_price"
                                    min="0" value="{{ old('product_price', $product->price) }}">
                            </div>
                        </div>
                        ...
                        <textarea class="form-control" rows="5" id="product_detail"
                            name="product_detail">{{ old('product_detail', $product->detail) }}</textarea>
